...
a_size = size(a); % a的尺寸
a_row = a_size(1, 1);
% 绘制平行于x轴的线段(0,0.8)至(a_row,0.8)，使用line([0 a_row], [0.8 0.8])画线段;
line([0 a_row], [0.8 0.8], 'linestyle', '--', 'Color', [0.5 0.5 0.5], 'LineWidth', 5);
...
l =legend(' Feedback LGMD ', ' Threshold ');
...
set(gca, 'ylim', [0, 1.05], 'ytick', [0 0.5 0.8 1.0]);
