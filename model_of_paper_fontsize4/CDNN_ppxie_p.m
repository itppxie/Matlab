...
% Collision Alarm
a=load('D:\matlabWorkspace\model_of_paper_fontsize4\results\oneLine.txt');
plot(a(:,1),a(:,2),'-r','LineWidth',6);
hold on;

% xlabel('Frames','fontsize',45);       % 原始
% ylabel('Excitation','fontsize',45);
xlabel('Frames','fontsize',53);         % 修改第一处 
ylabel('Excitation','fontsize',53);

grid off;

l = legend(' Collision Alarm ');
set(l, 'Box', 'off'); % 隐藏图例的外边框

% set(gca,'linewidth',1,'fontsize',45,'fontname','Times'); % 原始字体
set(gca,'linewidth',1,'fontsize',53,'fontname','Times');   % 修改第二处
...
hold on;
annotation('textbox',...
    [0.56588579795022 0.954162031162886 0.192503660322133 0.0569620253164556],... % 修改第四处
    'String',{'Ground truth:'},...
...
annotation('line',[0.699853587115666 0.819180087847731],...
    [0.98030303030303 0.98030303030303],'LineWidth',11,...           % 修改第六处
    'Color',[0.501960813999176 0.501960813999176 0.501960813999176]);
