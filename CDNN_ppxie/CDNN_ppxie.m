...
% LGMD Neuron
% a=load('C:\Users\Administrator\Desktop\ScienceResearch\CDNN_ppxie\CDNN\results\kf.txt');
a=load('.\results\kf.txt');
plot(a(:,1),a(:,2),'-g','LineWidth',3);
hold on;

% Threshold Level
% a=load('C:\Users\Administrator\Desktop\ScienceResearch\CDNN_ppxie\CDNN\results\Ts.txt');
a=load('.\results\Ts.txt');
plot(a(:,1),a(:,2),'--b','LineWidth',3);
hold on;

% % Collision Alarm
% a=load('C:\Users\Administrator\Desktop\ScienceResearch\CDNN_ppxie\CDNN\results\warning.txt');
