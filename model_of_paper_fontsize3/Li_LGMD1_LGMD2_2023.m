...
% 画一条垂直于x轴的虚线段(20, 0)至(20, 1.3)，表示warning time
line([20 20], [0 1.15], 'linestyle', '--', 'Color', 'r', 'LineWidth', 3); % 红色
...
annotation('textbox', [0.2,0.2,0.3,0.4], 'LineStyle', '-', 'LineWidth', 2, 'String', 'Warning Time', 'FitBoxToText', 'on', 'fontsize', 45, 'Color', 'r', 'fontname','Times');
% annotation('textbox', [0.2,0.2,0.3,0.4], 'LineStyle', '-', 'LineWidth', 2, 'String', 'Crash Time', 'FitBoxToText', 'on', 'fontsize', 45, 'Color', 'b', 'fontname','Times');
