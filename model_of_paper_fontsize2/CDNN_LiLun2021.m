...
% CDNf
a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\CDNf.txt');
plot(a(:,1),a(:,2),'-g','LineWidth',3);
hold on;

% Tf
a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\Tf.txt');
plot(a(:,1),a(:,2),'--b','LineWidth',3);
hold on;

% Alarm
a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\Alarm_f.txt');
...
legend(' CDN Neuron', ' Threshold Level ', ' Collision Alarm ');
