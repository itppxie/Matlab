...
% 注意：CDPNN之前的，即划分成左侧区域、前向区域和右侧区域的！！！
...
% LDN
a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\kf_Left.txt');
plot(a(:,1),a(:,2),'--g','LineWidth',3);
hold on;
% Left_direction
a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\Left_direction.txt');
plot(a(:,1),a(:,2),'-g','LineWidth',6);
hold on;

% RDN
a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\kf_Right.txt');
plot(a(:,1),a(:,2),'--b','LineWidth',3);
hold on;
% Forward_direction
a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\Right_direction.txt');
plot(a(:,1),a(:,2),'-b','LineWidth',6);
hold on;

% FDN
a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\kf_Forward.txt');
plot(a(:,1),a(:,2),'--m','LineWidth',3);
hold on;
% Forward_direction
a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\Forward_direction.txt');
