...
% L
a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\L-FVPNN.txt');
plot(a(:,1),a(:,2),'-g','LineWidth',3);
hold on;

% R
a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\R-FVPNN.txt');
plot(a(:,1),a(:,2),'--r','LineWidth',3);
hold on;

% F
a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\F-FVPNN.txt');
plot(a(:,1),a(:,2),'-b','LineWidth',3);
hold on;

% B
a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\B-FVPNN.txt');
...
legend(' L-FVPNN ', ' R-FVPNN ',' F-FVPNN ', ' B-FVPNN ');
