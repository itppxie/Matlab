...
a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\L.txt'); % L 绿色
plot(a(:,1),a(:,2),'-g','LineWidth',3);
hold on;

a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\R.txt');  % R 蓝色
plot(a(:,1),a(:,2),'-b','LineWidth',3);
hold on;

a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\U.txt');  % U 红色
plot(a(:,1),a(:,2),'-r','LineWidth',3);
hold on;

a=load('D:\matlabWorkspace\model_of_paper_fontsize2\results\D.txt');  % D 黑色-实线
