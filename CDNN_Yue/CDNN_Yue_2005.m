...
% LGMD Neuron
% a=load('E:\Awodebiancheng\PyCharm\ScientificResearch\CDNN_Yue\CDNN_Yue_2005\results\sf.txt');
a=load('.\results\LGMD_Yue2005\sf.txt');
plot(a(:,1),a(:,2),'-g','LineWidth',3);
hold on;

% Threshold Level
% a=load('E:\Awodebiancheng\PyCharm\ScientificResearch\CDNN_Yue\CDNN_Yue_2005\results\Ts.txt');
a=load('.\results\LGMD_Yue2005\Ts.txt');
plot(a(:,1),a(:,2),'--b','LineWidth',3);
hold on;

% Collision Alarm
% a=load('E:\Awodebiancheng\PyCharm\ScientificResearch\CDNN_Yue\CDNN_Yue_2005\results\warning.txt');
a=load('.\results\LGMD_Yue2005\warning.txt');
...
legend(' LGMD Neuron ', ' Threshold Level ',' Collision Alarm ');
