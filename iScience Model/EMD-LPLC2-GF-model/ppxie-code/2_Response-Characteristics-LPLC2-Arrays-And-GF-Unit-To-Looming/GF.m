...
% GF：整合来自LPLC2阵列的输入，当出现逼近物体时就会“尖峰放电”
...
N = numel(nums);                                  % 每帧中被激活的LPLC2神经元数量Nact？
...
set(gca,'XTickLabel',(-1:0.1:0));
ylabel('Numbers of activated neurons');
title('LPLC2 array');
figure(3)
plot(T,v,'k');
xlabel('Time to collision(s)');
