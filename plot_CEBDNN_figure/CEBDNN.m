...
a=load('E:\Awodebiancheng\VisualStudio2015\OpencvStudyingSolution\CEBDNN\resultDocument\Kf.txt');
plot(a(:,1),a(:,2),'-g','LineWidth',3);
hold on;

a=load('E:\Awodebiancheng\VisualStudio2015\OpencvStudyingSolution\CEBDNN\resultDocument\Tsp.txt');
plot(a(:,1),a(:,2),'--b','LineWidth',3);
hold on;

a=load('E:\Awodebiancheng\VisualStudio2015\OpencvStudyingSolution\CEBDNN\resultDocument\Kf_hat.txt');
...
legend(' Crowd Activity ', ' Threshold Level ',' Alarm Region ');
