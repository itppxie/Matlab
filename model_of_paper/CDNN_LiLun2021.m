...
% CDNf
a=load('D:\matlabWorkspace\model_of_paper\results\CDNf.txt');
plot(a(:,1),a(:,2),'-g','LineWidth',3);
hold on;

% Tf
a=load('D:\matlabWorkspace\model_of_paper\results\Tf.txt');
plot(a(:,1),a(:,2),'--b','LineWidth',3);
hold on;

% Alarm
a=load('D:\matlabWorkspace\model_of_paper\results\Alarm_f.txt');
