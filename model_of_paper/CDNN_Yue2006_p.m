...
% LGMD Neuron
a=load('D:\matlabWorkspace\model_of_paper\results\kf.txt');
plot(a(:,1),a(:,2),'-g','LineWidth',3);
hold on;

% Threshold Level
a=load('D:\matlabWorkspace\model_of_paper\results\Ts.txt');
plot(a(:,1),a(:,2),'--b','LineWidth',3);
hold on;

% Collision Alarm
a=load('D:\matlabWorkspace\model_of_paper\results\warning.txt');
