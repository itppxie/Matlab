...
% LDN
a=load('D:\matlabWorkspace\model_of_paper\results\Nf_L.txt');
plot(a(:,1),a(:,2),'--g','LineWidth',2);
hold on;

% DDN
a=load('D:\matlabWorkspace\model_of_paper\results\Nf_D.txt');
plot(a(:,1),a(:,2),'--b','LineWidth',2);
hold on;

% RDN
a=load('D:\matlabWorkspace\model_of_paper\results\Nf_R.txt');
